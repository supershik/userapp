...
const CartScreenFromCategoriesHome = ({ navigation, route }) => {
    ...
    const unsubscribe = navigation.addListener('focus', () => {
      ...
      const bootstrapAsync = async () => {
        ...
        if (userToken != null) {
          ...
          USERAPIKit.get('/user/cart/detail/shopcategory/' + shopcategoryinfo.shopcategoryid)
            .then(onSuccess)
            .catch(onFailure);
        }
        else {
  ...
  const orderProduct = () => {
    navigation.navigate('Shop Map', {orderProducts: products, shopcategoryinfo: shopcategoryinfo, fromView: fromView});
  }
...
export default CartScreenFromCategoriesHome;
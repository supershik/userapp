...
const OrderSummaryScreenFromMap = ({ navigation, route }) => {
  const [shop, setShop] = useState({
    shopname: route.params.shopInfo.shopname,
        ...
        headerRight: () => (
          <>
            <View style={{flexDirection: 'row', alignSelf: "center", marginRight: 5}}>
              ...
              {/* <TouchableOpacity
                  onPress={() => navigation.push('Map View')}>
                  <Image
                      source={icoShopmap}
  ...
  const onPressHomeView = () => {
    navigation.popToTop('Map View');
  ...
  const getTotalPrice = (data) => {
    ...
    console.log('DiscountPercent:' + shop.discount);
      ...
      <View style={styles.container}>
        ...
        <View>
            <ConfirmDialog
                ...
                title={"Place order to " + shop.shopname + "?"}
                visible={alert}
            >
...
export default OrderSummaryScreenFromMap;